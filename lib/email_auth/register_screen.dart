                ...
                child: ElevatedButton(
                  onPressed: ()async{
                    if(emailController.text == "" || passwordController.text == ""){
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Password dont not match with confirm password'), backgroundColor: Colors.red,));
                    }else{
                      User? result = await FirebaseServices().register(emailController.text, passwordController.text);
                      if(result != null){
                        print(result.email);
